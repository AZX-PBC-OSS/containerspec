...
class BuildahBackend:
    ...
    async def solve_and_export(
        ...
        *,
        ...
        # colon, so a colon in the path would be silently mis-split. Reject
        # up front, before spending time on the build.
        if output_type == "oci" and output_path and ":" in str(output_path):
            raise BuildError(
